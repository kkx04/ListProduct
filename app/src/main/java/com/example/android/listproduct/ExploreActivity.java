...
import com.example.android.BorrowBook;
import com.example.android.Model.Products;
import com.example.android.ViewHolder.ProductViewHolder;
...
public class ExploreActivity extends AppCompatActivity {
    ...
    protected  void onStart(){
        ...
        FirebaseRecyclerOptions<Products> options =
                ...
                .setQuery(ProductRef.orderByChild("Title").startAt(SearchInput), Products.class)
                .build();
